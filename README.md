...
Application web de sensibilisation pour le diabète de type 2
...
- Traitement en mémoire uniquement (grâce à Streamlit Cloud)
...
- **Choix éthique** : modèle interprétable préféré à Random Forest (moins explicable)
