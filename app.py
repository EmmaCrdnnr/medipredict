...
# ── CSS personnalisé (adaptatif light/dark) ─────────────────────────────────
st.markdown("""
<style>
/* Cartes */
.metric-card {
...
#Chargemente prédiction du risque de diabète.
Projet Jour 3 — Interface web complète.
"""
...
# ── CSS personnalisé ─────────────────────────────────────────────────────────
# Note : pas d'@import Google Fonts — bloque le rendu sur Colab (requête externe)
st.markdown("""
<style>
html, body, [class*="css"] {
...
div[data-testid="stSelectbox"] div { background: #1e293b; color: #f1f5f9; }
</style>
""", unsafe_allow_html=True)
...
if THEME == "dark":
 ...
 _text = "#f1f5f9"
 _muted = "#94a3b8"
 _banner_bg = "linear-gradient(135deg, #1e3a5f, #1e293b)"
 _banner_txt = "#bfdbfe"
 _info_bg = "#1e293b"
 _info_txt = "#94a3b8"
else:
 ...
 _text = "#0f172a"
 _muted = "#475569"
 _banner_bg = "linear-gradient(135deg, #eff6ff, #dbeafe)"
 _banner_txt = "#1e40af"
 _info_bg = "#f8fafc"
 _info_txt = "#475569"
...
with st.sidebar:
 ...
 st.markdown("""
 <div style="font-size:0.78rem; color:{_muted}; line-height:1.6;">
 Modèle : <b style="color:{_muted}">Régression Logistique</b><br>
 Dataset : <b style="color:{_muted}">Pima Indians (768 obs.)</b><br>
 Version : <b style="color:{_muted}">1.0.0</b>
 </div>
 """, unsafe_allow_html=True)
...
if page == " Accueil":
 ...
 st.markdown("""
 <div style="background:{_info_bg}; border-radius:8px; padding:1rem 1.5rem; color:{_info_txt}; font-size:0.88rem; line-height:1.8;">
 ...
 st.session_state.consent_given = False
 st.info("Info : Veuillez cocher la case ci-dessus pour accéder aux fonctionnalités.")
...
# ═══════════════════════════════════════════════════════════════════════
 ...
 st.markdown("""
 <div class="legal-banner">
 Info : Remplissez les champs ci-dessous avec vos valeurs médicales. Si une valeur ne s'applique pas,
 ...
 st.markdown("""
 <div style="background:{_info_bg}; border-radius:8px; padding:1rem; font-size:0.82rem; color:{_info_txt}; line-height:1.9;">
 ...
 <p style="color:{_muted}; font-size:1rem;">{r['risk_desc']}</p>
 <br>
 <p style="color:{_muted}; font-size:0.82rem;">
...
# ═══════════════════════════════════════════════════════════════════════
 ...
 st.info("Info : Commencez par remplir votre profil sur la page **Mon profil de risque**.")
 st.stop()
 ...
 st.markdown("""
 <div style="margin-top:1.5rem; padding:1rem; background:{_info_bg}; border-radius:8px; font-size:0.82rem; color:{_muted};">
...
# ═══════════════════════════════════════════════════════════════════════
 ...
 st.markdown("""
 <div class="metric-card">
 <p style="color:{_muted}; font-size:0.9rem; line-height:1.8;">
 ...
 st.markdown("""
 <div style="background:{_info_bg}; border-radius:8px; padding:1.2rem 1.5rem; color:{_info_txt}; font-size:0.88rem; line-height:2;">
